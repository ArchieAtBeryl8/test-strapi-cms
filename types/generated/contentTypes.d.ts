...
export interface ApiNewsandinsightsPageNewsandinsightsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'newsandinsights_pages';
  info: {
    displayName: 'newsandinsights-page';
    pluralName: 'newsandinsights-pages';
    singularName: 'newsandinsights-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::newsandinsights-page.newsandinsights-page'
    > &
      Schema.Attribute.Private;
...
export interface ApiPrivacypolicyPagePrivacypolicyPage
  ...
  info: {
    displayName: 'privacypolicy-page';
    pluralName: 'privacypolicy-pages';
    singularName: 'privacypolicy-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::privacypolicy-page.privacypolicy-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
